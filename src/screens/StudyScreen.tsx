...
const StudyScreen = ({ navigation }: any) => {
  // Derived subjects summary for UI
  const { derivedSubjects } = require('../data/derived');
  const [subjectCards, setSubjectCards] = useState<any[]>([]);
  const isFocused = useIsFocused();

  // Image URLs for subjects
  const subjectImages = [
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDgkrH_ANer4wNutEJ5vpXH4AqchLZjzpOeBFi5QiYwFDFcCELH-UfUAbv_KefVdasWL7dR0j3kFEXj2nzhSko6cmcsLzRlyKLm1pIlmK9T7hBA6SI9JBtx2YGQL60S8gxASQz3k0-BDrpwmJS7DGhOXDqP4G3582aVMys44LHp_Gf_cXMIoi8VlPLQJzXkc83BlZ8xP2SyM0A9fTC0fmuATRAPBl7TgiGBFLuDGM1D0jQyTUS6zpWoM-QiotyYExOD9Vhl7dU4Sjs',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuB0wJZlxXAvkI4IS9CP_qt1sULEObaWcZ18e-iM7sBPZGAm_ZtbK4_Ozi9HpuIyoof24fx50pN5npSp0RkiceGajEYxaDXmxQixD5_rvjRiX1wa15y9lVRvu85V-r0Vt8JnNGDj2Qy0OHsehiQxHQoJTwWqYqvLhMVT8tdl7s5XWRYQ9VN18aiOih0K3EY7mHPs9crwAynX-4oNEgT_szh2rA9yDdXYvcESsI5MFCXk2nzLJN5slGB_8ZbyrAC6ZYqoJaac38uHzto',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCsHYhsUGIDF2oOQg-NOInrft6Ev7wR9G01j8Cg4DtWjHkGln2ShqRY-nDN03dCzomVQySQWgWlbYc3Kp8nWuIRQ7N0WdNM3ZiJp-yHlKi5ht-C6O3-CUeAc_NFLxqixNkRFHQJP-J_Uf6ulvv41nswjWkPDmNKG3PysF5IsnIzyyO3Bs_WtVON05Fd_TMqxWtbkgkrtqsTq8HvahJfoDGt7qniQLAxvCOyRhSKfke_BzlyopVDFwrIi6vda-Cv7uC3zUt_hVBwvyI',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDsSsjOZnQ4yanIKOwlLfDQC96POeQEeh5gWvA9hB29kjeYuJkJZ_shyUvA0SmZYLFNokBhrzQhCJGKxvV_VJjufpU8DHC4BEyz7cUGJWuAPBxMu39BUnAXdh7w7r5Du_wOIRSNeWfffTKuiF0jwr8iDCbUE-kbL4dElU6G5L8dOm7CNU2_NEy47k3T7NnacO3jRSAZbRPGGHbeiit9QBh2YJqxBD7z55Nm0DwdRp8xxbB-sE0onJHI3dV4F4icHPuMn3qJ68p_bTY',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDuuY5G5F_08JKPP_TycRd_vFGCR6iMlchgamyxsHqBoPORN7jN5DhAWZVYcQt-pitYG5Zogd2CIfyAvQ6E-HcZaY0cFYzLDl95iDu8O83z9hnLX1pjyPM7SGk5huyeDiAMj09LR5fxASRo3GNBC73Px5a7gyOO-DbqCSh_kxk9O0gbqMncqVKBOqxppWAudall0H7CDQ9jmWEQXZ1ksQQciMeVutnozmv_1xbrm0L3H0g71biuYvyWcrJMPhL8mYqhtO646kT3juo',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAmV-vYPxfG6rEis7It_VD7ZMuUacmt9IBjtKbykmAoU_c8yKze5zKsE82ja9gwb5_o_oTkswi8brc7W04yj8WOno3vdQYobOp4bi1pWC7W6WlWavE7ANAYgkm1DKm4-F564y03cRSibUykC1ISAi7_8a98UKlC-8ttRRanzsCgXzOSpYdeJ8qZPFXkXcdiZBO9VCuDnug7dyouUeW_yFiL-7OOLBbW7o1XLeb5KqTf-URq2_hyKimHtpg10PSu_5Pkv70mL63Gxgg',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDxYdMSMjhh7q5rN9v_xmAB-mKBNFYyXUQrJJdkPk7Lmghv5nfPdQoZF-Po6B09L80s5LACSzTQzUDRZSbouuHPdakKc5CrBlZ8-gED5mEZrLi16fWl_FZQRYmUuotAut8iaLLDy3CEk-cOIHMvjJO9GVdAIYhZL0DhejYgCFgeJoMiK-bRpnYgGkSyTDlHPen2YWusoacK3zJrFt6kQ4jdgDNWYEhB3B0HOyjltULKkEm0sUwT_0aqHV4bdRYbOLo4xhLcqqYp0cU',
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAQ09YL4k-Z9h0pnPEnaq6NIYLwBvgaBfJbUXCSPKoEEAoH-ytjgj3qOj0ceQ-lKfc7i6IIbSOxLjayTXlgT8ri7IJP4A1X5kDdYgDA27dB2KnEovfpzg9GhB-GukVHrwcjuz5Ecc2vuZzLrICC0QPz3o2rKjvhX-TpFap_oUv36rPcgzcpDU9s9q4ZJ-VItSJ04BpRLtmcIB4U9OIysDDkk-yiI5wMY3ShQ2WDkaGf1bshw7eCBhW6LztIJhTlcwJ2l4-zSx-B_U4'
  ];

  useEffect(() => {
    const load = async () => {
      const cards = [] as any[];
      for (let i = 0; i < derivedSubjects.length; i++) {
        const s = derivedSubjects[i];
        let percentage = '—';
        try {
          const key = `progress:${s.name}`;
          ...
          if (saved) {
            ...
            if (s.totalQuestions > 0) {
              percentage = `${Math.round((answered / s.totalQuestions) * 100)}%`;
            }
          }
        } catch {}
        cards.push({
          ...
          name: s.name,
          percentage,
          questions: `${s.totalQuestions} 문제`,
          progress: percentage === '—' ? 0 : Number(percentage.replace('%','')),
          image: subjectImages[i] || subjectImages[0] // Use provided image or fallback to first
        });
      }
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <StatusBar barStyle="dark-content" backgroundColor="transparent" translucent />
                ...
                <Text style={styles.headerTitle}>과목</Text>
              </View>
